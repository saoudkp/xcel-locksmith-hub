        ...
        L.marker([loc.lat, loc.lng], { icon: keyIcon })
          ...
          .bindPopup(
            `<div style="font-family: 'Plus Jakarta Sans', sans-serif; min-width: 180px;">
              ...
              <a href="${defaultBrand.phoneNumber}" style="
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Serving Cleveland and {activeLocations.length} surrounding communities with fast 20–30 minute response times.
          </p>
        </motion.div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-2">
          {activeLocations.map((loc) => (
            <span key={loc.id} className="skeu-badge px-3 py-1.5 rounded-full text-xs text-foreground font-medium flex items-center gap-1">
