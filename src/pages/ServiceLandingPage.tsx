      ...
      <main>
              ...
              >
                <div className="rounded-3xl overflow-hidden neu-card">
                  <img
                    ...
                    alt={`${service.title} service in Cleveland, OH`}
                ...
                >
                  ...
                  <p className="font-display text-4xl font-bold text-accent">${service.startingPrice}</p>
                ...
                <div className="grid lg:grid-cols-2">
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div className="space-y-4 mb-8">
                      {[
                        { label: service.title, price: `$${service.startingPrice}+` },
        ...
        <ScrollReveal variant="fadeUp">
          <section className="py-20">
            <div className="container mx-auto px-4">
              <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-4">
                Serving <span className="font-serif-accent text-accent">Cleveland</span> & Beyond
              </h2>
              <p className="text-muted-foreground text-center max-w-xl mx-auto mb-10">
                {service.title} available across 24 cities in the Greater Cleveland metro area.
              </p>
                      ...
                      >
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="font-display font-bold text-accent">${rs.startingPrice}+</span>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4 max-w-3xl">
              ...
              <p className="text-muted-foreground text-center mb-12">
                Common questions about {service.title.toLowerCase()} in Cleveland.
              </p>
              ...
              <div className="neu-card rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="font-serif-accent text-xl md:text-2xl text-accent mb-2">
                    Cleveland's Fastest Response — 20–30 Minutes
                  </p>
