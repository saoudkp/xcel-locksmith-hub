                        ...
                        >
                          ...
                          >
                            ...
                            <div className="p-5">
                              ...
                              <p className="text-sm text-muted-foreground line-clamp-2 mb-2">{s.shortDescription}</p>
                              <span className="font-display font-bold text-accent text-sm">${s.startingPrice}+</span>
                            </div>
                          </Link>
                        </motion.div>
                      );
            ...
            <div className="container mx-auto px-4 text-center">
              <div className="neu-card rounded-3xl p-10 md:p-16 max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                  We arrive in 20–30 minutes with upfront pricing. No hidden fees. Licensed & insured.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  <motion.a
                    href={defaultBrand.phoneNumber}
