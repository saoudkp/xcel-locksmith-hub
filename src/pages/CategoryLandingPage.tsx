...
import { Phone, ArrowRight, ChevronRight, Shield, Clock, Star, BadgeCheck, MapPin } from "lucide-react";
  ...
  const schema = {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: services.map(s => ({
        ...
        priceSpecification: { "@type": "PriceSpecification", price: s.startingPrice, priceCurrency: "USD" },
      })),
    },
  };
      ...
      <main>
        ...
        <div className="pt-28 md:pt-32 pb-4 container mx-auto px-4">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span className="text-foreground font-medium">{meta.label} Services</span>
          </nav>
        </div>
                      ...
                      >
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between">
                            <span className="font-display font-bold text-accent">${s.startingPrice}+</span>
            ...
            <div className="container mx-auto px-4 text-center">
              <div className="neu-card rounded-3xl p-10 md:p-16 max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                  We arrive in 20–30 minutes, quote a fair price upfront, and get the job done right. No hidden fees. Ever.
                </p>
