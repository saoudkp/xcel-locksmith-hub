...
export const defaultNavItems: NavItem[] = [
  ...
  { id: "nav-team", href: "#team", label: "Our Team", isActive: true, order: 2 },
  { id: "nav-gallery", href: "#gallery", label: "Gallery", isActive: true, order: 3 },
  { id: "nav-vehicle", href: "#vehicle-verifier", label: "Vehicle Check", isActive: true, order: 4 },
  { id: "nav-quote", href: "#quote", label: "Free Quote", isActive: true, order: 5 },
  { id: "nav-reviews", href: "#reviews", label: "Reviews", isActive: true, order: 6 },
...
export const defaultSections: SectionConfig[] = [
  ...
  { id: "team", type: "team", isActive: true, order: 3, heading: "Meet Our Expert Team" },
  { id: "vehicle-verifier", type: "vehicle-verifier", isActive: true, order: 4, heading: "Vehicle Compatibility Check" },
  { id: "quote", type: "quote", isActive: true, order: 5, heading: "Get a Free Quote in Seconds" },
  { id: "gallery", type: "gallery", isActive: true, order: 6, heading: "Before & After Gallery" },
  { id: "reviews", type: "reviews", isActive: true, order: 7, heading: "What Our Customers Say" },
